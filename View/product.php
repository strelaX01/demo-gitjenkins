                ...
                if(isset($productID)){
                    ...
                    <div class="col-lg-7 col-md-7 col-xs-7 col-7 col-right">
                        ...
                        if(isset($check) && $check == 1){
                            ?>
                            <div class="message">
                                <h5 style="color:green;font-size:30px;">Thêm vào giỏ hàng thành công!!</h5>
                            </div>
                            <?php
                        }
                        ?>
                        <h4 class='title'><?php echo $productID['title']; ?></h4>
                        <p style="color:red;" class="descrip">
                        ...
                        <div class="price">
                            ...
                            if(isset($productID['sale_price'])){
                                ...
                                <span class="del-price">
                                    Giá:<?php echo $productID['regular_price']; ?> đ<br>
                                </span>
                                <span class="sale-price">
                                    Giá khuyến mại:<ins style="color:red;"><?php echo $productID['sale_price']; ?> đ</ins> 
                                </span>
                                <?php
                            }else{
                                ?>
