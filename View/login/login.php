	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST">
					...
					<div class="message">
						<?php if (isset($count)): ?>
							...
							<?php elseif ($count>0): ?>
								<?php header('location: http://localhost/milktea/milktea'); ?>
							<?php endif ?>
						<?php endif ?>
				...
				<div class="login100-more" style="background-image: url('./View/login/images/bg-02.jpg');background-size: cover;">
				</div>
			</div>
		</div>
	</div>
