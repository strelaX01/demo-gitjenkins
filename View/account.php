...
<body>
    ...
    <div class="container account">
        <h3>Xin chào,<span style="color:red;"> <?php echo $_SESSION['username']; ?></span></h3>
        <div class="action">
            <a class="home" href="http://localhost/milktea/milktea">Trang chủ</a>
        ...
        <?php
            ...
            ?>
            <div class="message">
                <p>Bạn chưa đặt đơn nào!!<a href="http://localhost/milktea/milktea"> Đặt hàng ngay </a></p>
            </div>
            <?php
        }
        ?>
