        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:info@company.com">info@.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:0395766944">0395766944</a>
                </div>
                <div>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled d-flex justify-content-between">
                                            <p><li class="text-muted text-right"><?php echo $value['price']; ?>đ</li></p>
                                        </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">BAO Caffe</h2>
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li>
                            ...
                            <a class="text-decoration-none" href="tel:010-020-0340">0395766944</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope fa-fw"></i>
                            <a class="text-decoration-none" href="mailto:info@company.com">info@.com</a>
                        </li>
                    </ul>
                </div>
