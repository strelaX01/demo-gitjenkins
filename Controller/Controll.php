            ...
            if(isset($_GET['action'])){
                ...
                switch($action){
                    ...
                    case 'logout':{
                        ...
                        unset($_SESSION['role']);
                        header('location: http://localhost/milktea/milktea/?action=login');
                        break;
                    }
                        ...
                        if(isset($_GET['add_categories'])){
                            if(isset($_POST['add_category'])){
                                ...
                                if($this->AddCategory($name, $img)){
                                    header('location: http://localhost/milktea/milktea/?action=manager&categories_manager');
                                }
                            }
                            ...
                            if(isset($_POST['add_product'])){
                                ...
                                if($check){
                                    if($this->AddProduct($title, $regular_price, $sale_price, $price, $img, $descrip, $id_category)){
                                        header('location: http://localhost/milktea/milktea/?action=manager&products_manager');
                                    }
                                }
                            }
                    ...
                    case 'delete_cart':{
                        if(isset($_GET['id'])){
                            ...
                            if($this->DeleteItemCart($id_cart)){
                                header('location: http://localhost/milktea/milktea/?action=cart');
                            }
                        }
                        break;
                    }
